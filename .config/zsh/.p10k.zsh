# Generated by Powerlevel10k configuration wizard on 2026-03-28 at 15:28 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 37983.
# Wizard options: nerdfont-v3 + powerline, large icons, ascii, lean, 24h time, 2 lines,
# solid, dark-ornaments, sparse, concise, transient_prompt, instant_prompt=verbose.
